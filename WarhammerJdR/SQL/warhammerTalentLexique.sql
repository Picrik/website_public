...
(
  ...
  'Pas d\'incantation imparfait si double'
),
(
  2,
  'Lire/Ecrire',
	'Maxi : Bonus d\'Initiative. Test : Focalisation (au choix). Votre expérience, Talent ou entraînement vous permet de manipuler de façon plus sûre les Vents de la Magie. Vous ne subissez pas d\'Incantation Imparfaite si vous obtenez un double à un Test de Focalisation.',
  'Lire/Écrire les langues parlées.'
),
(
	3,
  ...
  'Vous êtes capable de prouesses incroyables à cheval.'
),
...
(
  ...
  'Vous pouvez utiliser votre main non directrive bien mieux que la plupart des gens.'
),
...
(
  ...
  'Votre âme est pure, très résistante aux déprédation du Chaos.'
),
...
(
  ...
  'Vous possédez un talent naturel pour l\'art.'
),
...
(
  ...
  'Vos coups se succèdent rapidement et pleuvent sur votre adversaire avec la fureur d\'Ulric.'
),
...
(
  ...
  'Vous savez comment utiliser au mieux ce que les Dieux vous ont offert.'
),
...
(
  ...
  'Vous êtes entrainé à effectuer des frappes précises controlées sur l\'arme de voter adversaire, créant une ouverture pour une attaque.'
),
...
(
  ...
  'Vous êtes protégé par l\'un des dieux et vous povez intensifié le pouvoir de simples Prières.'
),
...
(
  ...
  'Vous êtes expérimenté dans la traversée de terrain difficiles.'
),
...
(
  ...
  'Vous avez des jambes solides capables de vous portez sur de grandes distances quand vous sautez.'
),
...
(
  ...
  'Vous êtes une sorte de touche-à-tout, capable de réparer presque n\'importe quoi.'
),
...
(
  ...
  'Vous avez l\'habitude de vous débrouillez avec peu, et savez comment survivre aux périodes de vache maiger.'
),
...
(
  ...
  'Vous avez réussi à conserver une apparence respectable malgré vos méfaits.'
),
...
(
  ...
  'Vous êtes à l\'aise en selle même dans les situations les plus difficiles, et savez comment tirer le meilleur de votre monture pendant les conflits.'
),
...
(
  ...
  'On prétend que lorsque vous êtes né, Randal a souri.'
),
...
(
  ...
  'Vous vous précipitez sur vos ennemis avec une témérité sans bornes, utilisant la force de votre charge pour ajouter un poids à vos frappes.'
),
...
(
  ...
  'Vous ëtes à l\'aise dans les ruelles sombres.'
),
...
(
  ...
  ' Vous savez comment tirer le meilleur parti de vos animaux.'
),
...
(
  ...
  'Peu importe à quel point les choses vont mal, vous persévérez malgré tout'
),
...
(
  ...
  'Vous avez appris tous les coups bas du comat à mains nues.'
  ),
...
(
  ...
  'Combat instinctif',
  'Maxi : Bonus d\'Initiative
  Vous réagissez aussi vite que l\'éclair. Votre Initiative est plus élevée de 10 pour déterminer l\'Initiative de Combat.',
  'Vous réagissez aussi vite que l\'éclair.'
),
...
(
  ...
  'Vous êtes entrainé à vous placer très près d\'un adversaire.'
),
...
(
  ...
  'Vous avez appris à tirer le meilleur parti des combats en espace clos.'
),
...
(
  ...
  'Vous êtes doué pour la fabrication de potions, de philtres et des décoctions.'
),
...
(
  ...
  'Vous pouvez plier votre corps en une myriade de positions apparemement anormales.'
),
...
(
  ...
  'Vous êtes davantage en mesure de contrôler votre Frénésie en combat.'
),
...
(
  ...
  'Vous savez ce qu\'il faut dire et à quel moment pour avoir le plus d\'impact sur vos supérieurs.'
),
...
(
  ...
  'Vous êtes musclés et habitué à porter des charges lourdes.'
),
...
(
  ...
  'Vous avez été formé à combattre côte à côte avec d\'autres soldats.'
),
...
(
  ...
  'Vous savez comment frapper fort !'
),
...
(
  ...
  'Vous êtes capable de désarmer un adversaire.'
),
...
(
  ...
  'Destinée',
  'Maxi : 1.
  A l\'âge de 10 ans, un Prêtre de Mort aussi appelé Augure, vous a pris à part pour prédire votre mort lors d\'un rituel de pasasge à l\'âge adulte, lourd d\'encens, appelé la Destinée. En accord avec votre MJ, proposez une Destinée appropriée. Si votre Personnage meurtd\'une façon y correspondant, votre prochain Personnage gagnera un bonus égal à la moitiié du total de PX accumulé par votre Personnage mort pendant la partie.',
  'WIP'
),
...
(
  ...
  'Vous êtes capable de déceler quand la magie réside dans un artefact.'
),
...
(
  ...
  'Vous lancez des attaques avec une détermination acharnée.'
),
...
(
  ...
  'Vous comprenez instinctivement la langue Magick.'
),
...
(
  ...
  Vous êtes doué pour suivre les gens sans vous faire remarquer. Vous pouvez utiliser les règles de Filature sans effectuer de Test combiné. Au lieu de celaa, vous effectuez simplement un Test de Perception ou de Discrétion, en fonction au plus élévé.',
  'Vous êtes doué pour suivre les gens sans vous faire remarquer.'
),
...
(
  ...
  'Vous êtes formé à effectuer des mouvements simples pour distraire ou surprendre votre adversaire.'
),
...
(
  ...
  'Vous gagnez un bonus permanent de +5 à votre Dexterité de départ.'
),
...
(
  ...
  ' Vous avez un don pour calculer et trouvez facilement la solution de la plupart des problèmes mathématiques.'
),
...
(
  ...
  'Vous gagnez autant de Points de Blessure supplémentaires que votre Bonus d\'Endurance.'
),
...
(
  ...
  'Vous êtes expert pour défoncer rapidement les portes et effectuer les effractions.'
),
...
(
  ...
  'Effrayant',
  'Maxi : Bonus de Force.
  Toute personne saine d\'esprit réfléchità deux fois avant de vous approcher. Si vous le souhaitez, vous avez un indice de peur de 1. Ajoutez +1 à cet indice par nombre de fois supplémentaire que vous avez pris ce Talent.',
  'Toute personne saine d\'esprit réfléchità deux fois avant de vous approcher.'
),
...
(
  ...
  'Il en faut beaucoup pour vous achever.'
),
...
(
  ...
  'Vous êtes habitué à faire valoir vos opignons et à les imposer.'
),
...
(
  ...
  'Vous êtes doué pour détourner l\'argent de vos employeurs sans vous faire prendre.'
),
...
(
  ...
  'Vous êtes un mendiant expérimenté, capable de faire mettre la main à la poche mêem aux individus les plus cyniques.'
),
...
(
  ...
  'Vous avez appris comment faire de fausses attaques en combat rapproché pour duper votre adversaire.'
),
...
(
  ...
  'Charme quand vous parlez pour défendre votre cause, votre situation ou votre religion, vos mots vibrent de passion et d\'ardente ferveur.'
),
...
(
  ...
  'Quand vous avez voué votre douleur au service de votre Dieu.'
),
...
(
  ...
  'Vous avez l\'habitude de vous retrouver dans de meuvaises sitations, et de préférence à vous en sortir.'
),
...
(
  ...
  'Vous savez où frapper un adversaire pour le faire tomber rapidement.'
),
...
(
  ...
  'Vous êtes un expert pour frapper vos ennemis aux endroits les plus vulnérables.'
),
...
(
  ...
  'Vous êtes doué pour frapper votre ennemi exactement là où vous le voulez.'
),
...
(
  ...
  'Vos réactions rapides vous ont permis de faire tomber de nombreux ennemis avant même qu\'ils aient eu le temps de dégainer.'
),
...
(
  ...
  'Quand votre vie ets en jeu, vous êtes capable de courir à une vitesse impressionnante.'
),
...
(
  ...
  'Vous êtes doué poru enflammer les foules.'
),
...
(
  ...
  'Vous êtes un exceptionnel grimpeur.'
),
...
(
  ...
  'Vous gagnez un bonus permanent de +5 à votre Caractéristique CC'
),
...
(
  ...
  'Vous connaissez toutes les astuces pour naviguer sur les rivières dangereuses.'
),
...
(
  ...
  'Vos prières exhalent la haine que vous éprouvez pour vos ennemis blasphématoires.'
),
...
(
  ...
  'Vous êtes consumé par la haine  pour quelque chose dans le Vieux Monde.'
),
...
(
  ...
  'Vous entretenez une identité secrète.'
),
...
(
  ...
  'Vous avez une bonne oreille pour les accents et dialectes et pour les reproduire avec exactitude.'
),
...
(
  ...
  'Vous gagnez un bonus permanent de +5 à FM'
),
...
(
  ...
  'Quand votre esprit est rivé sur une cible, personne ne peut vous empêcher de l\'atteindre.'
),
...
(
  ...
  'Vous êtes un vétéran blasé qui a survécu à plus d\'une rafale de tirs d\'armes à Poudre noire.'
),
...
(
  ...
  'Vous avez l\'échine solide, rompue au dur labeur.'
),
...
(
  ...
  'Les grands et puissants ne prêtent pas attention à votre présence.'
),
...
(
  ...
  'Vous êtes un maïtre en politique et vous dénichez les conspirations partout où elles se cachent.'
)
